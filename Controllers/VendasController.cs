...
namespace PadariaProj.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Data,TipoPagamento,ValorTotal")] Vendas vendas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Data,TipoPagamento,ValorTotal")] Vendas vendas)
        {
            if (id != vendas.Id)
            {
                return NotFound();
